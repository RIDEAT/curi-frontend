...
export default function SettingsDisplayPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <div>
          <a href="https://slack.com/oauth/v2/authorize?client_id=5305401263955.5790799264304&scope=channels:read,chat:write,chat:write.public,chat:write.customize&user_scope=chat:write">
            <img
              alt="Add to Slack"
              height="40"
              width="139"
          ...
          <a
            href="https://slack.com/oauth/v2/authorize?client_id=5305401263955.5790799264304&scope=channels:read,chat:write,chat:write.public,chat:write.customize&user_scope=chat:write&redirect_uri=https%3A%2F%2Fapp.dev.onbird.team%2Fslack
"
          >
            <img
              alt="Add to Slack"
